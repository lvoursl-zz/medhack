...
parser.add_argument( '-l', '--language', default='Russian', help='Recognition language (default: %(default))' )
...
group.add_argument( '-docx', action='store_const', const='txt', dest='format' )
